...
const PrivacyPolicy = () => {
    return (
        ...
        <div className='p'>
            ...
            <p><span style={{ color: 'rgb(68, 68, 68)' }}>A sua privacidade é importante para nós. É política do MTEVOLUTION respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <b><a href="https://mtevolution.tech">MTEVOLUTION</a></b>, e outros sites que possuímos e operamos.</span></p>
            ...
            <p><span style={{ color: 'rgb(68, 68, 68)' }}>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o MTEVOLUTION oferece no site e com caráter enunciativo, mas não limitativo:</span></p>
            <ul>
                ...
                <li><span style={{ color: 'rgb(68, 68, 68)' }}>B) Não difundir propaganda ou conteúdo de natureza racista, xenofóbica, ou azar, qualquer tipo de pornografia ilegal, de apologia ao terrorismo ou contra os direitos humanos;</span></li>
                <li><span style={{ color: 'rgb(68, 68, 68)' }}>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do MTEVOLUTION, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</span></li>
            </ul>
            ...
            <p><span style={{ color: 'rgb(68, 68, 68)' }}>Esta política é efetiva a partir de&nbsp;28 September 2024 08:23</span></p>
        </div>
        </>
    );
